 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
          ...
          + ant22.getMessage() + ant31.getMessage();						  //Person1 replace P1 with your name
		  //and gburdell1 with your gt id
		  Person1 p1 = new Person1("Valerie Avva");
		  toPrint += p1.toString("vavva3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Victor Chen");
		  toPrint += p2.toString("vchen36");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Sang-Chan Kim");
		  toPrint += p3.toString("skim937");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Michael Wang");
          toPrint += p4.toString("mwang370");
